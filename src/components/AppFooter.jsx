const AppFooter = () => {
    return (
        <footer class="bg-gray-200 dark:bg-gray-600">
            <div class="px-4 py-6 md:flex items-center justify-between text-center">
                ...
                <div class="flex mt-4 justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                    <a href="mailto:anshumankalathiya@gmail.com" class="text-gray-400 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725z" /></svg>
                        <span class="sr-only">Email Account</span>
                    </a>

                    <a href="https://www.linkedin.com/in/anshumankalathiya/" class="text-gray-400 hover:text-gray-900">
                    ...
                    <a href="https://github.com/Anshukalathiya" class="text-gray-400 hover:text-gray-900">
