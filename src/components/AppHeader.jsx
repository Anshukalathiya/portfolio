...
const AppHeader = () => {
    ...
    return (
        <nav class="bg-white border-gray-200 sticky top-0 z-[1001]">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto p-4">
                ...
                <div class={`w-full md:w-auto md:block ${isOpen ? 'block' : 'hidden'}`} id="navbar-default">
                    <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-12 lg:space-x-16 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
